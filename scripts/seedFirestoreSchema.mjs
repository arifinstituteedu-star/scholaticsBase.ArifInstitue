...
const firebaseConfig = {
    apiKey: 'AIzaSyDiUUCM57IRmiBDbJxkSTZSRWQEHvbg8BI',
    authDomain: 'scholasticbase-63086.firebaseapp.com',
    projectId: 'scholasticbase-63086',
    storageBucket: 'scholasticbase-63086.firebasestorage.app',
    messagingSenderId: '350798346819',
    appId: '1:350798346819:web:7ba5e56e03542157aa72f6',
    measurementId: 'G-554NGYYFK0',
};
